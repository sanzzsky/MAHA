...
categorical_columns = ['Sex', 'Hypertension', 'Diabetes', 'Exercises']
label_encoders = {}
...
# Output 2: Diet (10 classes, fixed)
output_diet = Dense(10, activation='softmax', name='Diet')(hidden)

# Create Model
model = Model(inputs=input_layer, outputs=[output_exercises, output_diet])
...
print(f"Test Loss (Exercises): {evaluation[1]}")
print(f"Test Accuracy (Exercises): {evaluation[3]}")
print(f"Test Loss (Diet): {evaluation[2]}")
print(f"Test Accuracy (Diet): {evaluation[4]}")
